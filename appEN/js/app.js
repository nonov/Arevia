...
arevia.config(['$routeProvider','$locationProvider', function ($routeProvider,$locationProvider) {
	...
	when('/profil', {
		templateUrl: '/Arevia/appEN/partials/profil.min.html'
	}).
	when('/influences', {
		templateUrl: '/Arevia/appEN/partials/influences.min.html'
	}).
	when('/interventions', {
		templateUrl: '/Arevia/appEN/partials/interventions.min.html'
	}).
	when('/choisirArevia', {
		templateUrl: '/Arevia/appEN/partials/choisirArevia.min.html'
	}).
	when('/boutique', {
		templateUrl: '/Arevia/appEN/partials/boutique.min.html'
	}).
	when('/contact', {
	...
	when('/leMondeDArevia', {
		templateUrl: '/Arevia/appEN/partials/leMondeDArevia.min.html',
		controller: 'BlogCtrl',
		resolve: {
